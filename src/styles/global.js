const styles = {
  ...
  section: "flex justify-center items-center p-16 sm:p-1 sm:pt-8",
  ...
  btnIcon: " minmd:w-10 minmd:h-10 ",

  featureImg: "w-40 h-40 minlg:w-40 minlg:h-40 object-contain mb-1",
  featureText:
